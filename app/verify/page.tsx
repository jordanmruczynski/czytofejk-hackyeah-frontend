...
const translations = {
  pl: {
    ...
    examples: {
      ...
      imageExample: "Przykład Obrazu AI",
      tryThis: "Wypróbuj ten przykład",
    },
    imageVerification: {
      title: "Wykrywanie Obrazów AI",
      description:
        "Prześlij obraz lub wklej skopiowany obraz (Ctrl+V), aby sprawdzić, czy został wygenerowany przez sztuczną inteligencję",
      selectImage: "Wybierz Obraz",
      pasteHint: "Lub wklej skopiowany obraz (Ctrl+V)",
  ...
  en: {
    ...
    examples: {
      ...
      imageExample: "AI Image Example",
      tryThis: "Try this example",
    },
    imageVerification: {
      title: "AI Image Detection",
      description:
        "Upload an image or paste a copied image (Ctrl+V) to verify if it was generated by artificial intelligence",
      selectImage: "Select Image",
      pasteHint: "Or paste copied image (Ctrl+V)",
...
export default function Home() {
  ...
  const loadExampleImage = async () => {
    try {
      const response = await fetch("/images/fake-example.jpg")
      const blob = await response.blob()
      const file = new File([blob], "fake-example.jpg", { type: "image/jpeg" })
      ...
      // Scroll to image verification tab
              ...
              <CardContent className="space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>{t.imageVerification.pasteHint}</span>
                  </div>
                </div>
                ...
                <div
                  ...
                  onPaste={handlePaste}
                  tabIndex={0}
                  className="min-h-[200px] rounded-xl border-2 border-dashed border-border/50 bg-muted/20 p-4 transition-colors hover:border-primary/30 focus:border-primary/50 focus:outline-none"
                >
                  {imagePreview ? (
                    <img
                    ...
                    <div className="flex h-full min-h-[180px] flex-col items-center justify-center gap-3 text-center">
                      ...
                      <div className="space-y-1">
                        <p className="text-sm font-medium">Kliknij tutaj i wklej obraz (Ctrl+V)</p>
                        <p className="text-xs text-muted-foreground">lub użyj przycisku wyboru pliku powyżej</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <CardContent>
                <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-gradient-to-br from-card/80 to-card/40 p-5 transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-3">
                      <div>
                        <h4 className="font-semibold text-sm">{t.examples.imageExample}</h4>
                        <p className="mt-1 text-xs text-muted-foreground line-clamp-2">
                          Potencjalnie wygenerowany obraz AI - kobieta z traktorem
                        </p>
                      </div>
                      <div className="overflow-hidden rounded-lg border border-border/30">
                        <img
                          src="/images/fake-example.jpg"
                          alt="Example AI generated image"
